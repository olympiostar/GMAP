...
(function(e){typeof define=="function"&&define.amd?define(["jquery","skel"],e):e(jQuery,skel)})(function(e,t)
	{var n="config",r="cache",i="setTimeout",s="trigger",o="_skel_layers_translateOrigin",u="position",f="_skel_layers_resetForms",
	l="$element",c="visibleWrapper",h="_skel_layers_translate",p="skel-layers-moved",
	d="moveToVisibleWrapper",v="_skel_layers_promote",m="exclusiveLayer",g="_skel_layers_resume",
	y="_skel_layers_demote",b="exclusive",w="moveToHiddenWrapper",E="center",S="right",x="_skel_layers_cssNumericValue",
	T="bottom",N="prototype",C="speed",k="css",L="left",A="wrapper",O="_skel_layers_init",M="_skel_layers_suspend",_="skel-layers-css-values",
	D="overflow-x",P="width",H="_skel_layers_doTranslate",B="transform",j="hidestart",F="layers",I="showstart",q="skel-layers-layer-z-index",
	R="_height",U="transition",z=null,W="hiddenWrapper",X="scrollTop",V="skel-layers-css",$="children",J="height",K="showend",Q="hideend",
	G=".skel-layers-fixed:not(.skel-layers-moved)",Y="iterate",Z="auto",et="deviceType",tt="resetForms",nt="unlockView",rt="top",
	it="touchstart.lock click.lock scroll.lock",st="recalcW",ot="element",ut="hidden",at="_width",ft=!0,lt='<div id="skel-layers-placeholder-',
	ct="_skel_layers_fadeOut",ht="parent",pt=!1,dt="length",vt="_skel_layers_fadeIn",mt="100%",gt="blur",yt="padding-bottom",bt="skel-layers-exclusiveVisible",
	wt="useActive",Et="_skel_layers_uncss",St="_skel_layers_recss",xt="easing",Tt="isInitialized",Nt="animation",Ct="lockView",kt="originalEvent",
	Lt="-webkit-tap-highlight-color",At="skel-layers-layer-position",Ot="#skel-layers-placeholder-",Mt="skel_layers_hiddenWrapper",_t="animations",
	Dt="animate",Pt="-webkit-",Ht="append",Bt="registerLocation",jt="skel-layers-layer-index",Ft="resize.lock scroll.lock",It="orientationchange.lock",
	qt="hasClass",Rt="z-index",Ut="_skel_layers_initializeCell",zt="breakpoints",Wt="positions",Xt="stopPropagation",Vt="touchPosX",$t="touchPosY",
	Jt="hide",Kt="preventDefault",Qt="canUseProperty",Gt="backface-visibility",Yt="events",Zt="-webkit-transition",en="undefined",tn="window",
	nn="_skel_layers_expandCell",rn="recalcH",sn="addClass",on="visible",un="none",an="_skel_layers_hasParent",fn="absolute",ln="-moz-",
	cn="-moz-transition",hn="handled",pn="data",dn="-ms-transition",vn="opacity",mn="rgba(0,0,0,0)",gn="show",yn="removeClass",bn="-o-transition",
	wn="appendTo",En="-ms-",Sn="getArray",xn="s ",Tn="states",Nn="ios",Cn="object",kn="_skel_layers_xcss",Ln="perspective",An="x",On="mode",
	Mn="fixed",_n="overflow-y",Dn="px",Pn="-",Hn="cell-size",Bn="side",jn="-o-",Fn="touches",In="isVisible",qn="find",Rn="*",Un="relative",zn="body",Wn="opacity ",Xn="htmlbody",Vn="#",$n="attr",Jn="html";
